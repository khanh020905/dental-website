  ...
  return (
    <div className="w-full">
      <div className="mb-10 lg:mb-12">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 mb-2">Đăng ký nội bộ</h2>
        <p className="text-gray-500 text-sm">
          Nhập thông tin cá nhân của bạn để xin cấp quyền truy cập hệ thống từ bộ phận Admin.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          {loading ? (
            ...
            <>
              Xác nhận Đăng Ký <UserPlus className="w-5 h-5" />
            </>
          )}
        </button>
        ...
        <button
          ...
          onClick={() => {
            ...
            setLoading(true);
            setTimeout(() => {
              router.push("/login"); // Simulate registration routing
            }, 1000);
          }}
        ...
        >
          ...
          Ghi danh bằng Google
        </button>

        <p className="text-center text-sm text-gray-500 mt-8">
          Bạn đã có tài khoản công ty cấp?{" "}
